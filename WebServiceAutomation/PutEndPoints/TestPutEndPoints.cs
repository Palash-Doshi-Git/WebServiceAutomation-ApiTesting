...
namespace WebServiceAutomation.PutEndPoints
{
    ...
    public class TestPutEndPoints
    {
        ...
        private readonly string securePutUrl = "http://localhost:8080/laptop-bag/webapi/secure/update";
        ...
        [TestMethod]
        public void TestSecurePutEndPointWithJSON()
        {
            ...
            restResponse = HttpClientHelper.PostRequest(securePostUrl, jsonData, jsonMediaType, jsonHeader);
            Assert.AreEqual(200, restResponse.StatusCode);
            ...
            restResponse = HttpClientHelper.PutRequest(securePutUrl, jsonData, jsonMediaType, jsonHeader);// Helper class Method 
            Assert.AreEqual(200, restResponse.StatusCode);

            restResponse = HttpClientHelper.GetRequest(secureGetUrl + id, jsonHeader);
        ...
        [TestMethod]
        public void TestSecurePutwithXML()
        {
            //Post - Create Record
            //Put - Update the record
            //Get - Verify the record
            ...
            restResponse = HttpClientHelper.PostRequest(securePostUrl, xmlData, xmlMediaType, xmlHeader);
            Assert.AreEqual(200, restResponse.StatusCode);
            ...
            restResponse = HttpClientHelper.PutRequest(securePutUrl, xmlData, xmlMediaType, xmlHeader);// Helper class Method 
            Assert.AreEqual(200, restResponse.StatusCode);

            restResponse = HttpClientHelper.GetRequest(secureGetUrl + id, xmlHeader);
            Laptop xmlObj = ResponseDataHelper.DeserializeXmlResponse<Laptop>(restResponse.ResponseContent);
            Assert.IsTrue(xmlObj.BrandName.Contains("Updated_Alienware"));
        }
